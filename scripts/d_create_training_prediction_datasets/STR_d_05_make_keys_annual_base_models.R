...
cm10 <- fst::read_fst(here::here('inputs', 'pm25', 'base_models', 'annual',
                               'formatted', 'cmout', 
                          'cmout_2010_formatted.fst')) 

cm15 <- fst::read_fst(here::here('inputs', 'pm25', 'base_models', 'annual',
                                 'formatted', 'cmout', 
                                 'cmout_2015_formatted.fst')) 
...
baseModels <- list(av, cc, cm10, cm15, gs, js, me, rk)
baseModelNames <- c('avAnnual','ccAnnual', 'cm10Annual','cm15Annual','gsAnnual', 
                    'jsAnnual', 'meAnnual', 'rkAnnual')
