function [W] = runPredictBNE(YYYY,inputset,Kscale, foldMethod, fold)
%YYYY = '2015';
%inputset = 'AVGSCMJSCC';
%Kscale = 6.5
%KscaleStr = '6.5'
...
fid = fopen(append('BNE_Inputs/c_03_parcels/annual/Predictions_', YYYY, '_AVGSCMJSCCM14M20CANNBGRD_1percent.csv'),'r'); % Creates id for reading in data line by line. A lot of the code below is 
line = str2num(fgetl(fid));

predCount = readtable(append('BNE_Inputs/c_03_parcels/annual/PredCount_', YYYY, '_AVGSCMJSCCM14M20CANNBGRD_1percent.csv'));
...
writematrix(results, append('BNE_Outputs/annual/bneOutputs_', YYYY, '_', inputset, '_', string(Kscale),'_', foldMethod, '_', fold, '.csv'))
