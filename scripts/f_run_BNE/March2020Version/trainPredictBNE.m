...
training = readtable(append('BNE_inputs/training/combined/Training_annual_', YYYY, '_AVGSCMJSCC_', fold, '.csv'));
...
fid = fopen(append('BNE_inputs/inputModels/combined/annual/Predictions_', YYYY, '_AVGSCMJSCC_', fold, '.csv'),'r'); % Creates id for reading in data line by line. A lot of the code below is 
line = str2num(fgetl(fid));

predCount = readtable(append('BNE_inputs/inputModels/combined/annual/PredCount_', YYYY, '_AVGSCMJSCC_', fold, '.csv'));
