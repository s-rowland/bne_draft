function [W,w0,Z,piZ,Zt,MSE] = BNE_v1_0_nosigw(y,X,time,models,num_rand_feat,len_scale_space,len_scale_time,len_scale_space_bias,len_scale_time_bias,penalty, time_metric)
