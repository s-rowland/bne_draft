function [W] = train_predict_BNE_sp(YYYY, inputset,len_scale, fold, resid)
% % 
% % === Inputs ===
% % 
...
trainAqs = training{:,4};
trainPred = training{:,5:(4+num_models)};
...
[W,w0,SigW,Z,piZ] = BNE_sp(trainAqs, trainLatlon, trainPred, num_rand_feat, len_scale, resid)
