function [W] = train_predict_BNE_spt2(inputset,len_scale_space_w,len_scale_time_w, ...
    len_scale_space_w0,len_scale_time_w0, fold)
% % 
% % === Inputs ===
% %  
...
[W,w0,SigW,Z,piZ, Zt] = BNE_spt2(trainAqs,trainLatLon,trainTime, ...
    trainPreds,num_rand_feat,len_scale_space_w,len_scale_time_w, ...
    len_scale_space_w0,len_scale_time_w0)
...
for time =  1:6 %temp:30:temp+365
    ...
    for i = 1:size(X,1)
        ...
        PhiW = sqrt(2/num_rand_feat)*cos(Z*X{i,:}'/len_scale_space_w + Zt*time/len_scale_time_w + piZ);
        PhiW0 = sqrt(2/num_rand_feat)*cos(Z*X{i,:}'/len_scale_space_w0 + Zt*time/len_scale_time_w0 + piZ);
...
% 4b save as csv
    writetable(results, append('BNE_outputs/spatiotemp_annual/BNE_',...
        inputset, '_', string(len_scale_space_w),'_', string(len_scale_time_w),...
        '_',num2str(YYYY), '_', fold, '_twoKernel.csv'))
