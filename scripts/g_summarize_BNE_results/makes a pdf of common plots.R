...
# weights
cowplot::plot_grid(
  plotSpatial_oneBNEParameter(BNEoutput,RunID, 'w_mean','AV', '', 'LegN'),
  plotSpatial_oneBNEParameter(BNEoutput,RunID, 'w_mean','GS', '', 'LegN'),
  plotSpatial_oneBNEParameter(BNEoutput,RunID, 'w_mean','CM', '', 'LegN'),
  plotSpatial_oneBNEParameter(BNEoutput,RunID, 'w_mean','JS', '', 'LegN'),
  plotSpatial_oneBNEParameter(BNEoutput,RunID, 'w_mean','CC', '', 'LegY'),
  nrow = 3)

# bias distribution 
plotSpatial_oneBNEParameter(BNEoutput,RunID, 'bias_mean','', '', 'LegY')

# bias uncertainty
plotSpatial_oneBNEParameter(BNEoutput,RunID, 'bias_sd','', '', 'LegY')

# pred distribution 
plotSpatial_oneBNEParameter(BNEoutput,RunID, 'pred_mean','', '', 'LegY')

# pred uncertainty
plotSpatial_oneBNEParameter(BNEoutput, RunID, 'pred_sd','', '', 'LegY')
