# File: STR_1_createRefGridNoJS.R
# Author: Sebastian T. Rowland <sr3463@cumc.columbia.edu>
# Date: 12/22/21

#' \code{createRefGridNoJS} creates a reference grid with a user-specified density
#' 
...
createRefGridNoJS <- function(AOI, 
                              makePlot = TRUE, 
                              targetDir = 'Desktop') {
  ...
  refGrid.aoi %>% 
    fst::write_fst(here::here(targetDir,  
...
#refGrid <-
 # fst::read_fst(here::here('ancillary_data', 'generated',  
  #                          'refCities.fst'))
