...
#> ℹ 3 files totaling 60.24 MB will be downloaded to '/Users/sebastianrowland/Desktop/BNE/bne_draft/scripts/k_addPmData-master/s3_downloads'
#> → Downloading 3 files.
#> → Got 0 files, downloading 3
#> → Got 1 file, downloading 2
#> → Got 2 files, downloading 1
#> ✓ Downloaded 3 files in 3.3s.
