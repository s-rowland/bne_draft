...
if(!exists("Ran_a_00_counsApp")){
  here::i_am("README.md")
  source(here::here('str_app_uncertainty_distribution', 'scripts', 
...
BNEoutputs <- readBNEoutput_str(2010, 'noOffset') %>% 
  bind_rows(readBNEoutput_str(2011, 'noOffset')) %>%
  bind_rows(readBNEoutput_str(2012, 'noOffset')) %>%
  bind_rows(readBNEoutput_str(2013, 'noOffset')) %>%
  bind_rows(readBNEoutput_str(2014, 'noOffset')) %>%
  bind_rows(readBNEoutput_str(2015, 'noOffset')) 



pdf(here::here('str_app_uncertainty_distribution', 'outputs', 'noOffset',
               'uncert check.pdf'))
...
# 1a Read combined BNE outputs
BNEoutputs <- readBNEoutput_str(2010, 'Offset') %>% 
  bind_rows(readBNEoutput_str(2011, 'Offset')) %>%
  bind_rows(readBNEoutput_str(2012, 'Offset')) %>%
  bind_rows(readBNEoutput_str(2013, 'Offset')) %>%
  bind_rows(readBNEoutput_str(2014, 'Offset')) %>%
  bind_rows(readBNEoutput_str(2015, 'Offset')) 
